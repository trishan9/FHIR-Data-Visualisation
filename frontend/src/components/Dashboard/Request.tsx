...
import { columns } from "@/app/(medications)/request/_components/columns";
...
const MedicationRequest: React.FC = () => {
    ...
    const getData = async () => {
      try {
        ...
        const data = await axios.get(
          `${FHIR_URL}/MedicationRequest?_count=10000`,
        );
  ...
  return (
    <>
      <h2 className="mb-6 text-2xl font-semibold">Medication Request Table</h2>
